...
<html lang="en">
  ...
  <div class="pemandangan">
      <nav class="navbar navbar-expand-lg">
        ...
        <section id="home">
    <div class="jumbotron">
    <img src="Bandung-removebg-preview.png " class="rounded mx-auto d-block" alt="...">
<br>
...
<section id="tokoh" class= "bg-dark pb-5" >
  ...
  <div class="card-body">
    ...
    <div class="col-4">
    <div class="card" style="width: 18rem;">
  <img src="A.H Nasution.jfif" class="card-img-top" alt="...">
  <div class="card-body">
    ...
    <div class="col-4">
    <div class="card" style="width: 18rem;">
  <img src="Ismail Marzuki.jfif" class="card-img-top" alt="...">
  <div class="card-body">
    <p class="card-text">Ismail Marzuki (11 Mei 1914 – 25 Mei 1958) adalah salah seorang komponis besar Indonesia. Namanya sekarang diabadikan sebagai suatu pusat seni di Jakarta yaitu Taman Ismail Marzuki (TIM) di kawasan Cikini, Jakarta Pusat.</p>
  </div>
</div>
    </div>
</div>
